...
void MitosisSteppable::init ( SimulatorPtr simulator, CC3DXMLElement *_xmlData )
{
...
//////////////////////////////////////////////////////////////////////////////
bool MitosisSteppable::divideClusterPixelsOrientationVectorBased ( 
set<PixelTrackerData> & clusterPixels , set<PixelTrackerData> & clusterParent , 
set<PixelTrackerData> & clusterChild, double _nx, double _ny, double _nz )
{
    if ( !_nx&&!_ny&&!_nz )
    {
        return false; //orientation vector is 0
