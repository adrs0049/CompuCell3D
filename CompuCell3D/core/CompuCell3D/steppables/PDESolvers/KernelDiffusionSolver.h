...
public:
    ...
    DiffusionData * getDiffusionData()
    {
        return &diffData;
    }
    SecretionDataKernel * getSecretionData()
    {
        return &secrData;
    }
};
...
class PDESOLVERS_EXPORT KernelDiffusionSolver :public DiffusableVectorCommon<float, Array3DContiguous>, public Steppable
{
...
public :
    ...
    typedef vector< vector <vector<float> > > Array3D;
...
protected:
    ...
    void writePixelValue ( Point3D pt,float value, unsigned int coarseGrainFactor,ConcentrationField_t & _concentrationField );
...
public:
    ...
    void setCurrentStep ( unsigned int _currentStep )
    {
