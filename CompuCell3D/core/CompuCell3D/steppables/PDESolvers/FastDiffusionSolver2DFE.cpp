				...
				if(doUptakeFlag){
					if(uptakeInMediumFlag && ! currentCellPtr){
						if(currentConcentration*relativeUptakeRateInMedium>maxUptakeInMedium){
							...
							concentrationField.setDirect(x,y,concentrationField.getDirect(x,y)- currentConcentration*relativeUptakeRateInMedium);
						}
					}
					if(currentCellPtr){
						...
						if(mitrUptake!=end_mitrUptake){
							if(currentConcentration*mitrUptake->second.relativeUptakeRate > mitrUptake->second.maxUptake){
								concentrationField.setDirect(x,y,concentrationField.getDirect(x,y)-mitrUptake->second.maxUptake);
								...
								concentrationField.setDirect(x,y,concentrationField.getDirect(x,y)- currentConcentration*mitrUptake->second.relativeUptakeRate);
							}
						}
					}
				}
