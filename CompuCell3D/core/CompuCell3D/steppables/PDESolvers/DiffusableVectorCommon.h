...
public:
    BoundaryStrategyPtr getBoundaryStrategy() const
    {
        return boundaryStrategy;
    }
    unsigned int getMaxNeighborIndex() const
    {
        return maxNeighborIndex;
    }
    Array_t * getConcentrationField ( int n )
    {
        return concentrationFieldVector[n];
    }
    void setConcentrationFieldName ( int n, std::string const &name )
    {
        concentrationFieldNameVector[n]=name;
    }
    std::string getConcentrationFieldName ( int n )
    {
        return concentrationFieldNameVector[n];
    }
