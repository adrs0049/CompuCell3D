...
public:
    ...
    SteadyStateSecretionData * getSecretionData()
    {
        return &secrData;
    }
};

class PDESOLVERS_EXPORT SteadyStateDiffusionSolver2D :public DiffusableVectorFortran<Array2DLinearFortranField3DAdapter >
{
