...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlexibleReactionDiffusionSolverFE::init ( SimulatorPtr _simulator, CC3DXMLElement *_xmlData )
{
...
void FlexibleReactionDiffusionSolverFE::solveRDEquations()
{
    ...
    for ( int fieldIdx=0 ; fieldIdx<numberOfFields; ++fieldIdx )
    {
        ...
        if ( diffSecrFieldTuppleVec[fieldIdx].diffData.diffConst==0.0 && diffSecrFieldTuppleVec[fieldIdx].diffData.decayConst==0.0 && diffSecrFieldTuppleVec[fieldIdx].diffData.additionalTerm=="0.0" )
        {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlexibleReactionDiffusionSolverFE::scrarch2Concentration ( ConcentrationField_t *scratchField, ConcentrationField_t *concentrationField )
{}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlexibleReactionDiffusionSolverFE::readConcentrationField ( std::string fileName,ConcentrationField_t *concentrationField )
{
