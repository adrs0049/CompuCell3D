...
public:
    ...
    SecretionDataFlex * getSecretionData()
    {
        return &secrData;
    }
};
...
class PDESOLVERS_EXPORT FlexibleDiffusionSolverFE :public DiffusableVectorCommon<float, Array3DContiguous>, public Steppable
{
