...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float FlexibleDiffusionSolverADE::couplingTerm(Point3D & _pt,std::vector<CouplingData> & _couplDataVec,float _currentConcentration){
...
void FlexibleDiffusionSolverADE::diffuseSingleField(unsigned int idx)
{
	...
	vector<vector<vector<float> > > newU(workFieldDim.x, vector<vector<float> >(workFieldDim.y, vector<float>(workFieldDim.z, float(0))));
	...
	//X faces boundary
	tmp[0] = 1; tmp[1] = workFieldDim.x - 2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlexibleDiffusionSolverADE::scrarch2Concentration( ConcentrationField_t *scratchField, ConcentrationField_t *concentrationField){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void FlexibleDiffusionSolverADE::readConcentrationField(std::string fileName,ConcentrationField_t *concentrationField){
