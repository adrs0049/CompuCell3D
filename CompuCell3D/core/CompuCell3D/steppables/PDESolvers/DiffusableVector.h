...
public:
    ...
    {
        std::cerr<<"Default constructor DiffusableVector"<<endl;
    };
    ...
    {
        return concentrationFieldNameVector;
    }
    std::vector<Array3DBordersField3DAdapter<precision> * > getConcentrationFieldVector()
    {
        return concentrationFieldVector;
    }
...
protected:
    ...
    std::vector<Array3DBordersField3DAdapter<precision> * > concentrationFieldVector;
