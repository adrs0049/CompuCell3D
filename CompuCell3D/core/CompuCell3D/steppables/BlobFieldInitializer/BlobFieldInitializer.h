...
public:
    ...
    void Center ( Point3D _center )
    {
        center=_center;
    }
    void Radius ( int _radius )
    {
        radius=_radius;
    }
...
public:
    ...
    bool engulfment;
    void BottomType ( std::string _bottomType )
    {
        bottomType=_bottomType;
    }
    void TopType ( std::string _topType )
    {
        topType=_topType;
    }
    void EngulfmentCoordinate ( std::string _engulfmentCoordinate )
    {
        engulfmentCoordinate=_engulfmentCoordinate;
    }
    void EngulfmentCutoff ( unsigned int _engulfmentCutoff )
    {
        engulfmentCutoff=_engulfmentCutoff;
    }
};
