...
public:
    ...
    Accessor_t * getSimpleClockAccessorPtr() {
        return &simpleClockAccessor;
    }
    // SimObject interface
    virtual void init(Simulator *simulator, CC3DXMLElement *_xmlData=0);

    void setSimpleClockFieldPtr( Field3D<float> *_simpleClockFieldPtr) {
        simpleClockFieldPtr=_simpleClockFieldPtr;
    }
