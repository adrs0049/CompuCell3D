...
void ElasticityTrackerPlugin::init ( SimulatorPtr _simulator, CC3DXMLElement *_xmlData )
{
    xmlData=_xmlData;
    ...
    ///************************************************************************************************
    potts->getCellFactoryGroupPtr()->registerClass ( std::make_shared<TrackerAccessor_t> ( elasticityTrackerAccessor ) );
