...
void ConnectivityLocalFlexPlugin::init ( Simulator *simulator, CC3DXMLElement *_xmlData )
{
     ...
     potts->getCellFactoryGroupPtr()->registerClass ( std::make_shared<DataAccessor_t>(connectivityLocalFlexDataAccessor) );
...
std::string ConnectivityLocalFlexPlugin::steerableName()
{
     return toString();
}
std::string ConnectivityLocalFlexPlugin::toString()
{
     return "ConnectivityLocalFlex";
}