...
SurfaceTrackerPlugin::SurfaceTrackerPlugin()
    : cellFieldG ( nullptr ), boundaryStrategy ( nullptr ), potts ( nullptr ),
      maxNeighborIndex ( 0 )
{}
...
void SurfaceTrackerPlugin::init ( SimulatorPtr simulator, CC3DXMLElement *_xmlData )
{
...
std::string SurfaceTrackerPlugin::steerableName()
{
    return toString();
}

std::string SurfaceTrackerPlugin::toString()
{
