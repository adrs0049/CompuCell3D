...
bool FieldSecretor::_secreteInsideCell ( CellG * _cell, float _amount )
{
    ...
    pixelTrackerAccessor_t pixelTrackerAccessorPtr=pixelTrackerPlugin->getPixelTrackerAccessorPtr();
...
bool FieldSecretor::_secreteInsideCellAtBoundary ( CellG * _cell, float _amount )
{
    ...
    BoundaryPixelTrackerAccessor_t boundaryPixelTrackerAccessorPtr=boundaryPixelTrackerPlugin->getBoundaryPixelTrackerAccessorPtr();
