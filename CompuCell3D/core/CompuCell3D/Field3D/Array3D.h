...
{
public:
    Array3DField3DAdapter() : Field3DImpl<T> ( Dim3D ( 1,1,1 ),T() ) , 
    array3DPtr ( nullptr ) , containerPtr ( nullptr ) 
	{}
...
//       void setArray3DPtr(Array3D<T> * _ptr){ array3DPtr = _ptr;}
    ...
    typename Array3D<T>::ContainerType &  getContainer()
    {
        return array3DPtr->getContainer();
    }
...
public:
    ...
    std::vector<double> & getContainerRef()
    {
        return container;
    }
    double * getContainerArrayPtr()
    {
        return & ( container[0] );
    }
    ...
    virtual float getByIndex ( long _offset ) const override
    {
        return float();
    }
...
public:
    ...
    {
        return getDirect ( x+borderWidth,y+borderWidth,z+borderWidth );
    }
    void set ( int x,int y,int z, T t )
    {
        return setDirect ( x+borderWidth,y+borderWidth,z+borderWidth,t );
    }
...
public:
    ...
    {
        return getDirect ( x+borderWidth,y+borderWidth );
    }
    void set ( int x,int y, T t )
    {
        return setDirect ( x+borderWidth,y+borderWidth,t );
    }
