...
public:
    ...
    compartmentInventoryContainerType & getContainer()
    {
        return inventory;
    }
    ...
    //iterator part
    std::map<long,CellG *>::size_type getInventorySize()
    {
    ...
    compartmentInventoryIterator inventoryBegin()
    {
        return inventory.begin();
    }
    compartmentInventoryIterator inventoryEnd()
    {
        return inventory.end();
    }
    void incrementIterator ( compartmentInventoryIterator & _itr )
    {
        ++_itr;
    }
    void decrementIterator ( compartmentInventoryIterator & _itr )
    {
        --_itr;
    }
...
{
public:
    CellIdentifier ( long _cellId=0, long _clusterId=0 ) 
	:cellId ( _cellId ),clusterId ( _clusterId )
	{}
...
public:
    ...
    std::map<long,CellG *>::size_type getCellInventorySize()
    {
        return inventory.size();
    }
    int getSize()
    ...
    CellG * getCell ( cellInventoryIterator & _itr )
    {
        return _itr->second;
    }
    CC3DCellList  getClusterCells ( long _clusterId );
    ...
    CompartmentInventory & getClusterInventory()
    {
