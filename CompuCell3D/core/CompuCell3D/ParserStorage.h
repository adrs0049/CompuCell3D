...
public:
    ParserStorage()
        : pottsCC3DXMLElement ( nullptr ), metadataCC3DXMLElement ( nullptr ),
		updatePottsCC3DXMLElement ( nullptr ),
    ...
    {
        pottsCC3DXMLElement=_element;
    }
    void addMetadataDataCC3D ( CC3DXMLElement * _element )
    {
        metadataCC3DXMLElement=_element;
    }
    void addPluginDataCC3D ( CC3DXMLElement * _element )
    {
        pluginCC3DXMLElementVector.push_back ( _element );
    }
    void addSteppableDataCC3D ( CC3DXMLElement * _element )
    {
        steppableCC3DXMLElementVector.push_back ( _element );
    }
};
