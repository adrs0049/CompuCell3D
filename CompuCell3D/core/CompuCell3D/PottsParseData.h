...
class COMPUCELLLIB_EXPORT  EnergyFunctionCalculatorParseData:public ParseData
{
public:

    EnergyFunctionCalculatorParseData ( std::string _moduleName ) :ParseData ( _moduleName )
    {}
    virtual ~EnergyFunctionCalculatorParseData() {}
};

class COMPUCELLLIB_EXPORT  EnergyFunctionCalculatorStatisticsParseData:public EnergyFunctionCalculatorParseData
{
public:
    ...
    virtual ~EnergyFunctionCalculatorStatisticsParseData() {}
    ...
    void GatherResults ( bool _gatherResultsSpinFlip )
    {
        gatherResultsSpinFlip=_gatherResultsSpinFlip;
    }
    void OutputAccepted ( bool _outputAcceptedSpinFlip )
    {
        outputAcceptedSpinFlip=_outputAcceptedSpinFlip;
    }
    void OutputRejected ( bool _outputRejectedSpinFlip )
    {
        outputRejectedSpinFlip=_outputRejectedSpinFlip;
    }
    void OutputTotal ( bool _outputTotalSpinFlip )
    {
        outputTotalSpinFlip=_outputTotalSpinFlip;
    }
...
class COMPUCELLLIB_EXPORT  PottsParseData:public ParseData
{
public:
    PottsParseData() :
        ParseData ( "Potts" )
    ...
    {
        acceptanceFunctionName=_acceptanceFunctionName;
    }
    void FluctuationAmplitudeFunctionName ( std::string _fluctuationAmplitudeFunctionName )
    {
        fluctuationAmplitudeFunctionName=_fluctuationAmplitudeFunctionName;
    }
