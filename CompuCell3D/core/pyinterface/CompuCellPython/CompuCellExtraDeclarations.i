...
// #endif
	...
	std::shared_ptr<pluginName ## Plugin> get ## pluginName ## Plugin() {
...
%inline %{
	std::shared_ptr<Plugin> getPlugin(std::string _pluginName) {
    //Plugin * getPlugin(std::string _pluginName){
      return std::static_pointer_cast<Plugin>(Simulator::pluginManager.get(_pluginName));
   }

   std::shared_ptr<Steppable> getSteppable(std::string _steppableName) {
...
%inline %{
    std::shared_ptr<LengthConstraintPlugin> getLengthConstraintPlugin(){
         return std::static_pointer_cast<LengthConstraintPlugin>(Simulator::pluginManager.get("LengthConstraint"));
    }
    std::shared_ptr<LengthConstraintPlugin> getLengthConstraintLocalFlexPlugin(){
...
%inline %{
 ...
 std::shared_ptr<CleaverMeshDumper> getCleaverMeshDumper() {
