...
%template(Field3DFloat) CompuCell3D::Field3D<float>;
%template(Field3DImplFloat) CompuCell3D::Field3DImpl<float>;

%template(Field3DDouble) CompuCell3D::Field3D<double>;
%template(Field3DImplDouble) CompuCell3D::Field3DImpl<double>;
