...
public:
    ...
    std::vector<CC3DXMLElement*> * getBaseClass()
    {
        return ( std::vector<CC3DXMLElement*> * ) this;
    }
...
public:
    ...
    virtual void appendData ( std::string _data );
	...
	virtual CC3DXMLElementList& getChildren();
